...
public class Petition extends Persistence {
	...
	//Ruft den Datensatz fŸr eine gegebene PetitionID ab und mappt diesen auf das Objekt
	public Petition(int id){
        ...
        if(conn != null)
        {
            try {
            	...
            	//Statement lŠuft mit INNER JOIN, damit man den Kategorienamen gleich mitkriegt.
	...
	public void insert() {
		...
		if (conn != null) {
			try {	
				...
				//InsertID ermitteln
                //Die Methode ist effizienter als nochmal eine Abfrage auszufŸhren :)
